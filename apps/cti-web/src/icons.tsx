...
// "Missed / no answer" — a phone handset with a small ✕ at the top-right.
// Reads clearly at badge size (unlike the old phone-off slash, which looked
// like a scribble).
export const PhoneMissedIcon = (p: IconProps): JSX.Element => (
  <Svg {...p}>
    <path d="m16 2 6 6" />
    <path d="m22 2-6 6" />
...
export const SpeakerIcon = (p: IconProps): JSX.Element => (
  <Svg {...p}>
